    ...
    <div className="mt-10 p-5 bg-slate-200 flex md:flex-row  flex-col-reverse md:items-start items-center overflow-scroll">
      <div className="grid gap-5 lg:w-1/2 lg:mt-10 lg:ml-24 md:w-1/2 md:ml-5 mt-10">
        {cart.length > 0 ? (
          cart.map((item) => (
            ...
            >
              <div className="flex lg:flex-row gap-4 items-center flex-col ">
                ...
                <button
                  className={`lg:w-12 lg:h-12 w-8 h-8 bg-white shadow-md text-black text-2xl 
                    ${item.quantity === 1 ? "opacity-50 cursor-not-allowed" : "hover:bg-[rgb(38,64,87)] hover:text-white active:bg-[rgb(38,64,87)]"}
                    transition duration-300 ease-in-out flex items-center justify-center absolute bottom-2 lg:right-20 right-14 focus:outline-none`}
          ...
          <div className="  rounded-lg bg-white shadow-md lg:m-5 md:mr-5 w-full  p-10">
